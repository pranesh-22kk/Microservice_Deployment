...
if __name__ == "__main__":
    ...
    for c in num_clusters:
        for r in replicas:
            ...
            path = f"./results/karmada/" + reward_function + "/" + strategy + alg + "_deepsets_env_karmada_num_clusters_4_reward_" + reward_function + "_totalSteps_200000_run_1/" + alg + "_deepsets_env_karmada_num_clusters_4_reward_" + reward_function + "_totalSteps_200000"
            if os.path.exists(path):
                agent.load(path)
            else:
                print(f"Model file {path} not found, proceeding without loading.")
