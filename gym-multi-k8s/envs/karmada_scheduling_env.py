...
class KarmadaSchedulingEnv(gym.Env):
    ...
    def set_deployment_request(self, cpu, mem, replicas):
        from envs.utils import DeploymentRequest
        d = DeploymentRequest(name="user_input", cpu_request=cpu, memory_request=mem, num_replicas=replicas)
        self.deployment_request = d
